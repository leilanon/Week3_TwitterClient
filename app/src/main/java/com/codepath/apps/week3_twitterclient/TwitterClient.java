...
//
//	public void getAPIRateLimit(AsyncHttpResponseHandler handler){
...
//	}
	...
	public void composeNewTweet(String tweet_body, AsyncHttpResponseHandler handler) {
		String apiUrl = getApiUrl("statuses/update.json");
		RequestParams params = new RequestParams();
		params.put("status", tweet_body);
